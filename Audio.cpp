...
//---------------------------------------------------------------------------
void AudioSystem::PlayAudio( SoundID soundID, float volumeLevel, bool loop)
{
	...
	if( channelAssignedToSound )
	{
		...
		if(loop)
		{
			m_BGM = channelAssignedToSound;
			channelAssignedToSound->setMode( FMOD_LOOP_NORMAL );
			channelAssignedToSound->setLoopCount(-1);
		}
	}
}
...
void AudioSystem::Pause(bool pause)
{
	m_BGM->setPaused(pause);
}